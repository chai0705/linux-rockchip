cmd_arch/arm64/kernel/vmlinux.lds := /home/topeet/05_uboot/linux-rockchip/scripts/gcc-wrapper.py aarch64-linux-gnu-gcc -E -Wp,-MMD,arch/arm64/kernel/.vmlinux.lds.d -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/11/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DCC_USING_PATCHABLE_FUNCTION_ENTRY -DKASAN_SHADOW_SCALE_SHIFT= -fmacro-prefix-map=./=   -P -Uarm64 -D__ASSEMBLY__ -DLINKER_SCRIPT -o arch/arm64/kernel/vmlinux.lds arch/arm64/kernel/vmlinux.lds.S
